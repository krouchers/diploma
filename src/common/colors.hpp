...
namespace Color
{
    ...
    inline glm::vec3 green{glm::vec3{124, 172, 40} / 255.f};
    ...
    inline glm::vec3 outline{glm::vec3{242.0f, 153.0f, 41.0f} / 255.0f};
    inline glm::vec3 hover{glm::vec3{102, 102, 204} / 255.0f};
}